...
tags:
  ...
  - Script
---
- taken from https://github.com/jhocking/from-unity-wiki/blob/main/Messenger.cs
- Is the middle man in broadcast messenger system, routes messages between broadcasters and listeners
```cs
